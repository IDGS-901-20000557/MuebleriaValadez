...
const Tarjeta = ({numbertarjeta, name, expiration,id,getTarjetas}) => {
    ...
    const drop = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              axios.post("https://localhost:7010/api/Tarjeta/EliminarTarjeta?id=" + id + "&idUsuariob=" + idUsuario, data).then((res) => {
                Swal.fire(
                  'Eliminado',
  ...
  return (
    ...
    <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Eliminar" style={{cursor: 'pointer', fontSize: 'medium'}} className="mt-3" onClick={() => drop(id)}><i className="fas fa-times mx-2 mt-2 float-right"></i></a>
